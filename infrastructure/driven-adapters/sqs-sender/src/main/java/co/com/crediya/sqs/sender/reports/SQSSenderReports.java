package co.com.crediya.sqs.sender.reports;
...
public class SQSSenderReports implements ReportRepository {
    ...
    @Override
    public Mono<String> addNewPetitionReport(String message) {
        return send(message);
    }
}
